...
--
-- Host: localhost:8080
-- Generation Time: Nov 12, 2015 at 10:16 PM
...
--
-- Database: `benzene_test`
--
CREATE DATABASE IF NOT EXISTS `benzene_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `benzene_test`;
